// local copy of https://github.com/sindresorhus/p-throttle/blob/5b566f4eecab5b054840896287e46806585747db/index.js
// Without registry (see the README.md file for details).
...
export default function pThrottle ({ limit, interval, strict, signal, onDelay }) {
  ...
  return function_ => {
    const throttled = async function (...arguments_) {
      if (!throttled.isEnabled) {
        return await (async () => function_.apply(this, arguments_))()
      }
